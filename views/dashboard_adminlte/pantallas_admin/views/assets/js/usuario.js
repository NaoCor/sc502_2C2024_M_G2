...
/* Funcion para activación de usuarios */
function activar(id) {
...
/* Funcion para desactivación de usuarios */
...
$('#tbllistado tbody').on(
  ...
  function () {
      ...
      $('#Ecorreo').val(data[1]);
      $('#Enombre').val(data[2]);
      $('#Eprimer_apellido').val(data[3]);
      $('#Esegundo_apellido').val(data[4]);
      $('#Efoto').val(data[5]);
      $('#Enumero_telefonico').val(data[6]);
      return false;
  }
);

/* Funcion para modificación de datos de usuario */
