...
<header>
        ...
        <div class="container text-center mt-5">
            <img src="./assets/img/icon.png" alt="Safe Zone Logo" style="width: 200px; height: 200px;">
            ...
            <div class="row justify-content-center" style="margin-top: 50px;">
                <div class="col-12 col-md-6 mb-3">
                    <div class="card" style="width: 18rem; margin: auto;">
                        <img src="./assets/img/mapa2.1.png" class="card-img-top" alt="Mapa" style="display: block; margin: 0 auto;" width="150" height="250">
                        <div class="card-body">
                            <h5 class="card-title">Lugares Seguros</h5>
                            <p class="card-text"></p>
                            <a href="./lugares_seguros.php" class="btn" style="background-color: #6477e4; color: white;">Más Información</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 mb-3">
                    <div class="card" style="width: 18rem; margin: auto;">
                        <img src="./assets/img/solicitud.png" class="card-img-top" alt="Solicitud" style="display: block; margin: 0 auto;" width="150" height="250">
                        <div class="card-body">
                            <h5 class="card-title">Denuncias</h5>
                            <p class="card-text"></p>
                            <a href="./formulario.php" class="btn" style="background-color: #6477e4; color: white;">Más Información</a>
                        </div>
                    </div>
                </div>
            </div>
