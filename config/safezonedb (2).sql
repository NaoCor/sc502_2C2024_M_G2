...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-08-2024 a las 22:29:15
...
INSERT INTO `charla` (`idCharla`, `idPresentador`, `nombreCharla`, `fecha`, `hora`, `costo`, `idProvincia`, `idCanton`, `idDistrito`, `tipo`, `duracion`, `formato`, `objetivo`, `descripcionCorta`, `consiste`, `foto`) VALUES
(1, 8, '', '2024-08-07', '37:28:49', 2500, 1, 74, 31, 'Educativa', '00:00:00', 'Presencial', 'asdasfsff', 'asfsfasfas', 'fasfadfadfddf', 'sfasdfddadf'),
(3, 123456789, 'Naomi', '2024-08-24', '12:05:00', 0, NULL, NULL, NULL, 'Educativa', '00:00:02', 'Presencial', 'dasdads', 'adsadas', 'asdsadas', NULL),
(4, 0, '', '0000-00-00', '00:00:00', 0, NULL, NULL, NULL, '', '00:00:00', '', '', '', '', NULL),
(5, 112544, 'Experiencias compartidas', '2024-08-18', '14:34:00', 0, NULL, NULL, NULL, 'Ayuda', '00:00:02', 'Presencial', 'saXCACSAC', 'SACSACCASASC', 'SACASCCSASAC', NULL);
...
INSERT INTO `presentador` (`idPresentador`, `nombre`, `correo`, `numero_telefonico`) VALUES
(0, '', '', 0),
(8, 'Naomi', 'corellanaomi@gmail.com', 648986),
(112544, 'Naomi', 'corellanaomi@gmail.com', 6489886),
(112225444, 'Naomi', 'corellanao12@gmail.com', 648986),
(119320065, 'Naomi', 'corellanaomi@gmail.com', 64898605),
(119320066, 'Naomi', 'corellanao123mi@gmail.com', 648986052),
(123456789, 'Naomi', 'corellanao123@gmail.com', 648986),
(2147483647, 'Naomi', 'corellanao123@gmail.com', 648986052);
...
INSERT INTO `reserva` (`idReserva`, `idCharla`, `primerApellido`, `nombre`, `cedula`, `correo`, `metodoPago`, `total`) VALUES
(2, 1, 'Corella', 'Naomi', '64898605', '', 1, 1),
(3, 1, '', '', '', '', 0, 1);
...
INSERT INTO `usuario` (`idUsuario`, `nombre`, `primer_apellido`, `segundo_apellido`, `correo`, `numero_telefonico`, `contraseña`, `foto`, `idRol`) VALUES
(1, 'Naomi', 'Corella', 'F', 'corellanaomi@gmail.com', 64898605, '123', NULL, 1);
...
--
ALTER TABLE `charla`
  MODIFY `idCharla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `denunciado`
  MODIFY `idDenunciado` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `denunciante`
--
ALTER TABLE `denunciante`
  MODIFY `idDenunciante` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `lugaresseguros`
  MODIFY `idLugarSeguro` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `charla`
  ADD CONSTRAINT `charla_ibfk_1` FOREIGN KEY (`idProvincia`) REFERENCES `provincia` (`idProvincia`),
  ADD CONSTRAINT `charla_ibfk_2` FOREIGN KEY (`idCanton`) REFERENCES `canton` (`idCanton`),
  ADD CONSTRAINT `charla_ibfk_3` FOREIGN KEY (`idDistrito`) REFERENCES `distrito` (`idDistrito`),
